...
<!-- Q: are the data provided in the template processed with spatial information already? ie. all the species the the species data layer are species that exist in the country/region, based on IUCN and AquaMaps, just without spatial information?  -->
