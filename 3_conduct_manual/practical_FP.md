...
of the world’s population to high-end sushi. This goal, then, **_measures the
amount of seafood sustainably harvested in a given EEZ or region through any
means for use primarily in human consumption or export_** and thus includes
...
The first thing to consider is what species are fished, cultured or extracted in
your study area, and whether they are for human consumption or non-food trades
and partition them into proper goals.  Gather as much information about these
species as possible in order to quantify to quantify how much is taken, from
where, and with which practices. You will need at least catch or harvest
information (tonnes), but you will be able to develop more accurate models if
you also have information about effort, practices, and locations.

Maximum Sustainable Yield will be calculated based on available harvest
information and appropriate models.

Setting **reference points** will depend on the types of information you have.
<!---develop this a bit more here, but then more specifically in sub-sections
below--->
...
generally compares landings with Maximum Sustainable Yield. Unsustainable extraction methods, and over- or
 under-harvesting are penalized. A score of 100 means the country or region
...
<p style="font-size: 0.8em;"> Since Global 2012, several new data-poor approaches have been developed to
assess fisheries that leverage global ly-available information (Costello *et
...
single-species reference point.

The catch-MSY approach improves upon the method used in Global 2012 in that it
...
Although it is a data-poor method, the more complex approach better takes into
...
Besides harvest information, either by species or total amount, this goal requires _spatial information_. You would have to find maps determining
where coastal activities are allowed, or find other kind of data that tells you
the usage restrictions for activities in your waters. You might also have to
find assessments that have been made to identify the coastal and offshore
...
space therefore can be physical or social. Keep in mind that in the Global
