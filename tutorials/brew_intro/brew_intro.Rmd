...
(note: fyi the R `brew` package is different from 'homebrewing', which is something ohi-webapp creation also uses from the command line to run imageMagick to resize images.)
